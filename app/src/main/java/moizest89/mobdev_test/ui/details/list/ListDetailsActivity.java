...
import moizest89.mobdev_test.ui.details.image.ListDetailsImageActivity;
...
public class ListDetailsActivity extends BaseActivity implements IListDetailsView, OnItemClickListener{
    ...
    public void onItemClickListener(View view, int position) {
        ...
        bundle.putStringArrayList(INTENT_SENDED_DATA, (ArrayList<String>) mAdapter.getData());
        bundle.putInt(Util.INTENT_SENDED_DATA_POSITION, position);
        Util.changeActivity(this, ListDetailsImageActivity.class, bundle, false);
    }
}
